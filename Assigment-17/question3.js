...
function countStudents(students, sandwiches) {
  ...
  while (students.length > 0) {
    if (students[0] === sandwiches[0]) {
      ...
      students.shift(); // Remove the student from the queue
      sandwiches.shift(); // Remove the sandwich from the top of the stack
      unableToEat = 0; // Reset the count of consecutive students unable to eat
    } else {
      ...
      unableToEat++; // Increment the count of consecutive students unable to eat
